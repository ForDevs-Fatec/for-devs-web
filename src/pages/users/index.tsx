...
export function UsersPage() {
    ...
    function handleUpdateUser() {
        setLoading(true);
        api.put<UserData[]>(URI.USER_UPDATE, {
            headers: {
                Authorization: token
            }
        }).then((response) => {
                                                    ...
                                                    <DropdownMenuContent className='bg-neutral-800'>
                                                        ...
                                                        <Dialog>
                                                            ...
                                                            <DialogContent className="sm:max-w-[425px] text-zinc-50">
                                                                ...
                                                                <DialogFooter>
                                                                    <Button type="submit" onClick={handleUpdateUser}>Salvar Mudanças</Button>
                                                                </DialogFooter>
                                                            </DialogContent>
                                                        </Dialog>
                                                        ...
                                                        <Dialog>
                                                            ...
                                                            <DialogContent className="sm:max-w-[425px] text-zinc-50">
                                                                ...
                                                                <DialogFooter>
                                                                    ...
                                                                    <Button type="submit"  className='bg-red-600 hover:bg-red-700'>Excluir perfil</Button>
                                                                </DialogFooter>
                                                            </DialogContent>
                                                        </Dialog>
                                                    </DropdownMenuContent>
