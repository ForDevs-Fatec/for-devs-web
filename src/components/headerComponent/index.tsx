...
import { BarChart3, Users, Search, TrendingUp, Workflow } from "lucide-react";
...
export function HeaderComponent() {
  ...
  switch (path) {
    ...
    case "/metrics":
      ...
      break;
    case "/reliability":
      pageTitle = "Confiabilidade";
      pageSubtitle = "Confiabilidade";
      pageIcon = <Workflow className="w-5 h-5 text-zinc-50" />;
      break;
  }
      ...
      <div className="w-full">
        {location.pathname === "/users" ? (
            ...
            <div>
              <div>
                <span className="text-zinc-500 text-sm">
                  Pages /
                  <span className="text-zinc-50 ml-1">{pageSubtitle}</span>
                </span>
              </div>
          ...
          <>
            <div>
              <span className="text-zinc-500 text-sm">
                Pages /<span className="text-zinc-50 ml-1">{pageSubtitle}</span>
              </span>
            </div>
            <div className="flex gap-2 items-center">
              {pageIcon}
